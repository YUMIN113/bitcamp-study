...
public class App {
  ...
  public static void main(String[] args) {
    ...
    String content = "";
    String writer = "";
    String password = ""; // 별도로 지정해 주는 이유는 블럭 실행하고 나면 변수 사라지기 때문임(62,63,65 Line)
    ...
    int menuNo = keyboardInput.nextInt(); // 창에 숫자 입력하고 엔터치면 nextInt가 menuNo에 숫자만 보냄. 엔터 값은 여전히 남아있는 상태
